...
.eqv max_th 2 #LUGAR QUE DEFINE NÚMERO DE THREADS - NOSOS CASO = DUAS THREADS
#.eqv thread_v p1 p2 p3, prog2, prog3 //comentado pois vamos usar as threads abaixo no lugar
.eqv thread_v JThr_1, JThr_2
